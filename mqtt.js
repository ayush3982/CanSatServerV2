...
const data = "1095,2:16:11 pm,1,T,7.6,7.5,0.34,0.24,0.89,0.98,0.91,0.31,0.56,0.23,0.2,0.83,0.75,RELEASED,CXON"
...
client.on(
    ...
    () => {
        client.subscribe('presence', (err) => {
            if(!err){
                setInterval(() => {
                    client.publish('teams/' + TEAM_ID, getContainerData());
                }, 100);
            }
        });
    }
